                        ...
                        <span class="sr-only">Error:</span>Home</a>
                            <?php
                                ...
                                <a href="users.php" class="list-group-item" title="Manage Users"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                                                        <span class="sr-only">Error:</span>Manage Librarian</a> 

                                
  
                <a href="books.php?page=1" class="list-group-item" title="Books"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>
                        <span class="sr-only">Error:</span>Books</a>
                <a href="students.php?page=1" class="list-group-item" title="Manage Students"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                        <span class="sr-only">Error:</span>Manage Students</a>
